        ...
        <div className="relative w-full hero-section-wrapper">
          <div className="relative z-10 mx-auto theme-container">
            <div className="flex justify-center mt-[130px] xl:mt-[247px]">
              <div>
                <h1 className="text-24 sm:text-48 md:text-[65px] md:leading-[95px] font-semibold text-white text-center mb-7 md:mb-[60px] w-full max-w-[844px] mx-auto">
                  Torne seu atendimento mais eficiente com a 
                  <span className="text-[#1F7EF5]"> Zapye</span>
                </h1>
                <div className="flex justify-center mb-5 md:mb-[55px] w-full">
                  ...
                  Nossa plataforma centraliza conversas e oferece suporte contínuo e automatizado, 
                  permitindo respostas instantâneas por IA e chatbots para um atendimento ágil e disponível 24/7.
                  </p>
                </div>
                  ...
                  <div className="flex flex-col items-center gap-10 md:flex-row">
                    <Link href="/pricing">
                      <div className="home-two-btn-bg py-3.5 group bg-[#1F7EF5] border-transparent w-fit mt-2.5">
                        <span className="relative z-10 text-white transition-all duration-300 text-pone group-hover:text-[#1F7EF5] font-inter">
                          Teste Grátis
                        </span>
                        <svg
                ...
                >
                  <div className="relative img" ref={imageRef}>
                    <img
                      src="/assets/images/home-four/hero-thumb.png"
                      alt=""
